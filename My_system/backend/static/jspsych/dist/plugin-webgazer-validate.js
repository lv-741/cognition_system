      ...
      trial(display_element, trial) {
        ...
        <div id='webgazer-validate-container' style='position: relative; width:100vw; height:100vh; overflow: hidden;'>
          ...
          const show_validation_data = () => {
              ...
              wg_container.style.cssText="cursor: default;"
              html +=
...
<div class="validation-point" style="width:${trial.point_size/4}px; height:${trial.point_size/4}px; border-radius:${trial.point_size/4}px; border: 1px solid #ff0000; background-color: #ff0000; position: absolute; left:${x + 0.5}%; top:${y + 0.8}%;"></div>`;
          }
